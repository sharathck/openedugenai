export const gradesData = {
  ...
  'Grade 2': {
    Mathematics: [
      ...
      'Ordinal numbers',
      'Mental arithmetic strategies (e.g., making tens)',
      'Basic multiplication concepts (e.g., repeated addition)',
      'Basic division concepts (e.g., sharing equally)',
      'Time telling to the hour and half-hour',
      'Time telling to the nearest five minutes',
      'Reading analog and digital clocks',
      'Understanding a.m. and p.m.',
      'Coin values and counting coins',
      'Making coin combinations to make up given amounts',
      'Money concepts and calculations',
      'Identifying and comparing shapes (2D and 3D shapes)',
      'Understanding symmetry',
      'Basic fractions (halves, thirds, quarters)',
      'Measurement of length, weight, and capacity using standard units',
      'Comparing measurements',
      'Collecting and organizing data',
      'Reading and creating simple graphs (bar graphs, picture graphs, line plots)',
      'Patterns and sequences (identifying and extending patterns)',
      'Recognizing and creating patterns with numbers and shapes'
    ],
    Science: [
      'Plants and their parts (roots, stems, leaves, flowers)',
      'Plant life cycles',
      'Animal life and habitats',
      'Animal classification (mammals, birds, reptiles, amphibians, fish, insects)',
      'Food chains and life cycles',
      'Ecosystems and habitats (deserts, forests, oceans)',
      'Weather and seasons',
      'The water cycle',
      'Earth’s resources (soil, rocks, water, air)',
      'Conservation and recycling',
      'Matter and its states (solid, liquid, gas)',
      'Physical properties of objects (texture, flexibility, strength)',
      ...
      'Heat and its effects (melting, boiling)',
      ...
      'Making observations',
      'Recording data (charts, graphs)',
      'Scientific inquiry (asking questions, making predictions)',
      'Health and human body basics (senses, nutrition, hygiene)',
      'Life cycles of insects (e.g., butterfly, beetle)',
      'Environmental awareness (pollution, conservation)',
      'Properties of water (floating and sinking)'
    ]
  },
  'Grade 3': {
    Mathematics: [
